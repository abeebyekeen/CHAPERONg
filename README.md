...
<font><p align="justify">The only essential requirement of **CHAPERON*****g*** is, of course, <p><i class="fas" style="font-size:25px"> &#xf35d; </i></p> a functional installation of the <a href=https://www.gromacs.org/ target="_blank">GROMACS software</a> <sup><i class="fas fa-external-link-alt" style="color:green ; font-size:12px" ></i></sup> [GROMACS software](https://www.gromacs.org/) <sup><i class="fas fa-external-link-alt" style="color:green ; font-size:12px" ></i></sup> run on Linux <i class="fab fa-linux" style="font-size:20px"></i> (Ubuntu <i class="fab fa-ubuntu" style="font-size:20px ; color:#FF7F50"></i>) or Windows <i class="fab fa-windows" style="font-size:20px ; color:#288EEE"></i> (via the Windows Subsystem for Linux, WSL). You can download and install a version by visiting the [GROMACS documentation page](https://manual.gromacs.org/) <sup><i class="fas fa-external-link-alt" style="color:green ; font-size:12px" ></i></sup>, or you could find the latest version of GROMACS [here](https://manual.gromacs.org/current/index.html) <sup><i class="fas fa-external-link-alt" style="color:green ; font-size:12px" ></i></sup>.</p></font>
