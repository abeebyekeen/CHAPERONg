#############################################################################
#  CHAP_generate_kde_hist_optimize.py -- A python script to estimate and    #
#    optimize the histogram number of bins for probability density function #
#    and kernel density estimator                                           #
#  CHAP_generate_kde_hist_optimize.py is part of CHAPERONg                  #
